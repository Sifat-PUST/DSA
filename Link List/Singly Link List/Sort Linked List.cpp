...
void Swap_Object(node**head,node**tail,node*p,node*q,node*r)
{
    node*temp1=NULL;
    node*temp2=NULL;
    if(p==r)
    {
        ...
        temp1=q->link;//200
        temp2=p->link;//200
        p->link=temp1->link;//300
        temp1->link=temp2;//200
        *head=q->link;
        q->link=p;
        cout<<"head: "<<(*head)->link<<"  Head link :"<<(*head)->link->link<<endl;
    }
    else
    {
        if(*tail==q->link)
...
void Object_Sort(node**head,node**tail)
{
    node*temp1=*head;
    node*temp2=NULL;
    node*temp3=*head;
    while(temp1->link!=NULL)
    {
          ...
          node *ad=NULL;
          cout<<endl<<"****************"<<endl;
          cout<<temp1<<"   "<<temp1->link<<endl;
          while(temp2->link!=NULL)
          {
              cout<<"Temp2 :"<<temp2<<"  temp2->link :"<<temp2->link<<endl;
              if(min>temp2->link->data)
              {
                  min=temp2->link->data;
                  ad=temp2;
              }
          ...
          cout<<"While 1111111111"<<endl;
          Swap_Object(head,tail,temp3,ad,temp1);
          temp1=temp1->link;
          if(temp3->link==temp1)
              temp3=*head;
          else
...
void menu(node**head,node**tail)
{
    ...
    cout<<"Click 4: To Sort By Object."<<endl;
    cout<<"Click 0: To Exit."<<endl;
    cout<<"\tSelect :";
    cin>>choice;
    if(choice==1)
